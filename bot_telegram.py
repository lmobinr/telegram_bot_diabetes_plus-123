...
WEBHOOK_URL = os.getenv("https://telegram-bot-diabetes-plus.onrender.com")  # مثلا: https://your-app.onrender.com/webhook
...
if __name__ == "__main__":
    # ست کردن وبهوک
    application.bot.set_webhook(url='https://telegram-bot-diabetes-plus.onrender.com' + "/webhook")
